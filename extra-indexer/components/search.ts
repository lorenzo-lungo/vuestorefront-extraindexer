...
import { getSearchAdapter } from './searchAdapterFactory'
 ...
 * @return {Promise}
 */
export const extraQuickSearchByQuery = async ({ query, start = 0, size = 50, entityType = 'prince_faq', sort = '', storeCode = null, excludeFields = null, includeFields = null }): Promise<SearchResponse> => {
